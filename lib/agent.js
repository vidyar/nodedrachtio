	...
	switch( msg.type ) {			
		case 'notify':
			switch( msg.command ) {
				...
				case 'dialog':
					debug('got dialog event for dialog %s', msg.data.dialogId) ;
					this._router.dispatchDialogEvent( msg.data.dialogId, msg.data.message.eventName, msg.data.message.eventData ) ;
				break ;
