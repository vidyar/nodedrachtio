...
function MultiKeySession(opts) {
	...
	if( !this._uuid ) {
		this._uuid = uuid.v1() ;
		this._keyData = {} ;
		this._session = Object.create(SessionProto) ;	//a plain object in which to store items
...
MultiKeySession.prototype.save = function( cb ) {
	...
	//TODO: check if object really needs to be saved...hash of session, plus any change of keys
