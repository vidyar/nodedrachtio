...
function SipDialog(req, res, callbacks) {
	...
	if( 1 === arguments.length  && req.method !== 'INVITE' ) {
		...
		Resource.call( this, this.call_id ) ;
		return ;
	}
...
util.inherits(Resource, SipDialog);
...
SipDialog.loadFromSessionStore = function( store, callId, role, callback ) {
	var sid = 'dlg:' + req.callId + ";" + role ;
    store.get(sid, function(err, data){
        ...
        Object.defineProperty( dialog, 'sessionStore', {value: store}) ;
